...
<link crossorigin="anonymous" media="all" rel="stylesheet" href="https://github.githubassets.com/assets/notifications-subscriptions-menu.572fff1cb5c3caef1ac9.module.css" />
  ...
  <title>mpv-switch-both-audio/switch-both-audio.lua at main · 70sh1/mpv-switch-both-audio · GitHub</title>
  ...
  <meta name="request-id" content="D390:3508AF:4E47C5:6B476F:668669D4" data-pjax-transient="true"/><meta name="html-safe-nonce" content="91538d20c5394a8e13e7695cb4d3af230c3bd576807ff6e100559d30867922ee" data-pjax-transient="true"/><meta name="visitor-payload" content="eyJyZWZlcnJlciI6IiIsInJlcXVlc3RfaWQiOiJEMzkwOjM1MDhBRjo0RTQ3QzU6NkI0NzZGOjY2ODY2OUQ0IiwidmlzaXRvcl9pZCI6Ijg2MDYwNDIxNzcwNzM5OTgyOTIiLCJyZWdpb25fZWRnZSI6InNvdXRoYWZyaWNhbm9ydGgiLCJyZWdpb25fcmVuZGVyIjoic291dGhhZnJpY2Fub3J0aCJ9" data-pjax-transient="true"/><meta name="visitor-hmac" content="c87cc4851fe6e7f2f8d0f816468cc6dd070165912fe74932bc7fccb83e1ef90d" data-pjax-transient="true"/>


    <meta name="hovercard-subject-tag" content="repository:718127455" data-turbo-transient>
...
<meta name="octolytics-url" content="https://collector.github.com/github/collect" />
  ...
  <meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-turbo-transient="true" />
    ...
    <meta name="viewport" content="width=device-width">
      ...
      <meta name="description" content="An mpv script that allows switching between playing one or two audio tracks simultaneously upon file load or with a hotkey - mpv-switch-both-audio/switch-both-audio.lua at main · 70sh1/mpv-switch-both-audio">

      <link rel="search" type="application/opensearchdescription+xml" href="/opensearch.xml" title="GitHub">

    <link rel="fluid-icon" href="https://github.com/fluidicon.png" title="GitHub">
    <meta property="fb:app_id" content="1401488693436528">
    <meta name="apple-itunes-app" content="app-id=1477376905, app-argument=https://github.com/70sh1/mpv-switch-both-audio/blob/main/switch-both-audio.lua" />

      <meta name="twitter:image:src" content="https://opengraph.githubassets.com/4c18eb1f8e3241e81439247daa338ebdee2640ed82704e0037092701283d9147/70sh1/mpv-switch-both-audio" /><meta name="twitter:site" content="@github" /><meta name="twitter:card" content="summary_large_image" /><meta name="twitter:title" content="mpv-switch-both-audio/switch-both-audio.lua at main · 70sh1/mpv-switch-both-audio" /><meta name="twitter:description" content="An mpv script that allows switching between playing one or two audio tracks simultaneously upon file load or with a hotkey - 70sh1/mpv-switch-both-audio" />
  <meta property="og:image" content="https://opengraph.githubassets.com/4c18eb1f8e3241e81439247daa338ebdee2640ed82704e0037092701283d9147/70sh1/mpv-switch-both-audio" /><meta property="og:image:alt" content="An mpv script that allows switching between playing one or two audio tracks simultaneously upon file load or with a hotkey - 70sh1/mpv-switch-both-audio" /><meta property="og:image:width" content="1200" /><meta property="og:image:height" content="600" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="mpv-switch-both-audio/switch-both-audio.lua at main · 70sh1/mpv-switch-both-audio" /><meta property="og:url" content="https://github.com/70sh1/mpv-switch-both-audio/blob/main/switch-both-audio.lua" /><meta property="og:description" content="An mpv script that allows switching between playing one or two audio tracks simultaneously upon file load or with a hotkey - 70sh1/mpv-switch-both-audio" />
  ...
  <meta name="go-import" content="github.com/70sh1/mpv-switch-both-audio git https://github.com/70sh1/mpv-switch-both-audio.git">

  <meta name="octolytics-dimension-user_id" content="54360854" /><meta name="octolytics-dimension-user_login" content="70sh1" /><meta name="octolytics-dimension-repository_id" content="718127455" /><meta name="octolytics-dimension-repository_nwo" content="70sh1/mpv-switch-both-audio" /><meta name="octolytics-dimension-repository_public" content="true" /><meta name="octolytics-dimension-repository_is_fork" content="false" /><meta name="octolytics-dimension-repository_network_root_id" content="718127455" /><meta name="octolytics-dimension-repository_network_root_nwo" content="70sh1/mpv-switch-both-audio" />
...
<header class="Header-old header-logged-out js-details-container Details position-relative f4 py-3" role="banner" data-color-mode=light data-light-theme=light data-dark-theme=dark>
  ...
  <div class=" d-flex flex-column flex-lg-row flex-items-center p-responsive height-full position-relative z-1">
    ...
    <path d="M8 0c4.42 0 8 3.58 8 8a8.013 8.013 0 0 1-5.45 7.59c-.4.08-.55-.17-.55-.38 0-.27.01-1.13.01-2.2 0-.75-.25-1.23-.54-1.48 1.78-.2 3.65-.88 3.65-3.95 0-.88-.31-1.59-.82-2.15.08-.2.36-1.02-.08-2.12 0 0-.67-.22-2.2.82-.64-.18-1.32-.27-2-.27-.68 0-1.36.09-2 .27-1.53-1.03-2.2-.82-2.2-.82-.44 1.1-.16 1.92-.08 2.12-.51.56-.82 1.28-.82 2.15 0 3.06 1.86 3.75 3.64 3.95-.23.2-.44.55-.51 1.07-.46.21-1.61.55-2.33-.66-.15-.24-.6-.83-1.23-.82-.67.01-.27.38.01.53.34.19.73.9.82 1.13.16.45.68 1.31 2.69.94 0 .67.01 1.3.01 1.49 0 .21-.15.45-.55.38A7.995 7.995 0 0 1 0 8c0-4.42 3.58-8 8-8Z"></path>
      ...
      <div class="flex-1">
        <a href="/login?return_to=https%3A%2F%2Fgithub.com%2F70sh1%2Fmpv-switch-both-audio%2Fblob%2Fmain%2Fswitch-both-audio.lua"
          class="d-inline-block d-lg-none flex-order-1 f5 no-underline border color-border-default rounded-2 px-2 py-1 color-fg-inherit"
          data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;site header menu&quot;,&quot;repository_id&quot;:null,&quot;auth_type&quot;:&quot;SIGN_UP&quot;,&quot;originating_url&quot;:&quot;https://github.com/70sh1/mpv-switch-both-audio/blob/main/switch-both-audio.lua&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="7b5114da9635c7d63460c703e26560969d0dfff514c3fd80c7b343c0492e8e64"
...
<qbsearch-input class="search-input" data-scope="repo:70sh1/mpv-switch-both-audio" data-custom-scopes-path="/search/custom_scopes" data-delete-custom-scopes-csrf="JZ1mT-y96pstCj0KgNlsyAM6yvwdMs44U4gL-rL6KYFwiV5HCy1HpGLPpP6K3sZQfEgTfV-dszFnBxWOEkI-Ug" data-max-custom-scopes="10" data-header-redesign-enabled="false" data-initial-value="" data-blackbird-suggestions-path="/search/suggestions" data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations" data-current-repository="70sh1/mpv-switch-both-audio" data-current-org="" data-current-owner="70sh1" data-logged-in="false" data-copilot-chat-enabled="false" data-blackbird-indexed-repo-csrf="<esi:include src=&quot;/_esi/rails_csrf_token_form_hidden?r=3ft57%2F2tAH9q3bsMRS5r54kgKLogv%2FzG%2B%2FbBWeFEN2p9wWogFEZC%2FrqpGU5GK8oXysYO%2FzXhEGM%2BcWrLOaKu%2BWZO6XiI%2FcatjhXrKEUkMZdo44GUaHtbyKHEqoWxGsyoZoxVlKa7SF43Ve9iU5J0VgJfd5f%2BmnI9sZZn%2FX8FRcbbMBcxO1brStAyVTwwtd784QbD%2FqQ9st%2By3S5gUfWIvvyr%2BRIsGoCIIBjlGLpWjZ%2Bsz9bV%2BpXUKnCQJZ2sP4ubnKX69XBlclxFn93g2HNjrmPCa0kdYpKWc61fLaLhPDpTcbZypMUDNUynMZEOL95zWsj%2BncpyFPAO0sX6yuLSBGgaUcWAZCA8YyqH4xEhro2D5qPSrPISvZhB90OwUI68SL969gI6glfXKcFJHIUQGxfGdwnZuwmoLSZMJjJtiU4HQi4iNdGhL8FaeJ0v%2F8qzgVq8stX7NKC1LE2IKem%2BW8mcUp8jdVKCMmUpy8Z5Wg5lgDXkMYfhXvWm%2B05DEbxg2LfHUgUtmY%2BJK3w0zpvztv9XLPiUeza8nKSIAcQlzNWp7bI%2FTcDZfisTW0NnWfNuHgA1RYGsZsrgHKQNncfQelr9LHORwQ%3D%3D--yC32EufYeJ2fCxtK--z6n976I6cvl4%2BkCXnpHxzw%3D%3D&quot; />">
  <div
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <div data-target="query-builder.styledInputContainer" class="QueryBuilder-StyledInputContainer">
          ...
          <div class="QueryBuilder-InputWrapper">
            ...
            <input id="query-builder-test" name="query-builder-test" value="" autocomplete="off" type="text" role="combobox" spellcheck="false" aria-expanded="false" aria-describedby="validation-3c5245ed-c70d-4c25-bbab-9c84637ea81e" data-target="query-builder.input" data-action="
...
<template id="device-desktop-icon">
  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-device-desktop">
    <path d="M14.25 1c.966 0 1.75.784 1.75 1.75v7.5A1.75 1.75 0 0 1 14.25 12h-3.727c.099 1.041.52 1.872 1.292 2.757A.752.752 0 0 1 11.25 16h-6.5a.75.75 0 0 1-.565-1.243c.772-.885 1.192-1.716 1.292-2.757H1.75A1.75 1.75 0 0 1 0 10.25v-7.5C0 1.784.784 1 1.75 1ZM1.75 2.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25ZM9.018 12H6.982a5.72 5.72 0 0 1-.765 2.5h3.566a5.72 5.72 0 0 1-.765-2.5Z"></path>
      ...
      <div class="FormControl-inlineValidation" id="validation-3c5245ed-c70d-4c25-bbab-9c84637ea81e" hidden="hidden">
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="feedback-dialog-title">
        <div data-view-component="true" class="Overlay-body">        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="code-search-feedback-form" data-turbo="false" action="/search/feedback" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="tKw8q2q8WU2+IDBSLWuPe3UIfKHftz9+tEb8g5GvmLqqvtHqod3Dpe/tpciP0OKDGWVzdS7u8mBqkywI3jEa/w==" />
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="custom-scopes-dialog-title">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="9CGEWEtYJCyG4CJAnd/X/qnkBSE8HqxvM2Sfhn1Ici7FACvSauAL1R070e2XNY9J+DoKifPoCDsnCjvILEHu2Q==" />
          ...
          <div class="form-group">
            ...
            <auto-check src="/search/custom_scopes/check_name" required>
              <input
                ...
                required
                maxlength="50">
              <input type="hidden" data-csrf="true" value="Y4XlZ4d1i1BcM8hUUYkqde8KLyYna0x5H+9YI9l8QoX27vc2x8MWWcn/nXXpg/PrW9ZZtRqO8DBf6mWbV3l5pA==" />
            </auto-check>
          </div>
      ...
      <div data-view-component="true" class="Overlay-footer Overlay-footer--alignEnd Overlay-footer--divided">          <button data-action="click:custom-scopes#customScopesCancel" type="button" data-view-component="true" class="btn">    Cancel
...
</qbsearch-input><input type="hidden" data-csrf="true" class="js-data-jump-to-suggestions-path-csrf" value="RFWLkkV5oCPuIwf5MDPE52pmThCHuKrXPXR1vCT5EbU/QUfV6sR5qkj7yEoEgaIWvSrLlUox8i2NWGCZaQmKEw==" />
          ...
          <div class="position-relative mr-lg-3 d-lg-inline-block">
            ...
            <a href="/signup?ref_cta=Sign+up&amp;ref_loc=header+logged+out&amp;ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Fblob%2Fshow&amp;source=header-repo&amp;source_repo=70sh1%2Fmpv-switch-both-audio"
    ...
    <button id="icon-button-207442df-e5a4-436d-9821-1dc8eb9c0986" aria-labelledby="tooltip-78d9cae4-a609-4d3f-a147-abce21fe166c" type="button" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium flash-close js-flash-close">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x Button-visual">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg>
</button><tool-tip id="tooltip-78d9cae4-a609-4d3f-a147-abce21fe166c" for="icon-button-207442df-e5a4-436d-9821-1dc8eb9c0986" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Dismiss alert</tool-tip>
...
<div class="flash flash-full   {{ className }}">
  ...
  <div class=" d-flex flex-wrap flex-items-center wb-break-word f3 text-normal">
    ...
    <span class="author flex-self-stretch" itemprop="author">
      <a class="url fn" rel="author" data-hovercard-type="user" data-hovercard-url="/users/70sh1/hovercard" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/70sh1">
        70sh1
</a>    </span>
    <span class="mx-1 flex-self-stretch color-fg-muted">/</span>
    <strong itemprop="name" class="mr-2 flex-self-stretch">
      <a data-pjax="#repo-content-pjax-container" data-turbo-frame="repo-content-turbo-frame" href="/70sh1/mpv-switch-both-audio">mpv-switch-both-audio</a>
    </strong>
  ...
  <li>
            <a href="/login?return_to=%2F70sh1%2Fmpv-switch-both-audio" rel="nofollow" id="repository-details-watch-button" data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;notification subscription menu watch&quot;,&quot;repository_id&quot;:null,&quot;auth_type&quot;:&quot;LOG_IN&quot;,&quot;originating_url&quot;:&quot;https://github.com/70sh1/mpv-switch-both-audio/blob/main/switch-both-audio.lua&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="f8d42ff82fddef90f0d3711a0196298aec8429542962796459ba631c35ae6f97" aria-label="You must be signed in to change notification settings" data-view-component="true" class="btn-sm btn">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-bell mr-2">
    <path d="M8 16a2 2 0 0 0 1.985-1.75c.017-.137-.097-.25-.235-.25h-3.5c-.138 0-.252.113-.235.25A2 2 0 0 0 8 16ZM3 5a5 5 0 0 1 10 0v2.947c0 .05.015.098.042.139l1.703 2.555A1.519 1.519 0 0 1 13.482 13H2.518a1.516 1.516 0 0 1-1.263-2.36l1.703-2.554A.255.255 0 0 0 3 7.947Zm5-3.5A3.5 3.5 0 0 0 4.5 5v2.947c0 .346-.102.683-.294.97l-1.703 2.556a.017.017 0 0 0-.003.01l.001.006c0 .002.002.004.004.006l.006.004.007.001h10.964l.007-.001.006-.004.004-.006.001-.007a.017.017 0 0 0-.003-.01l-1.703-2.554a1.745 1.745 0 0 1-.294-.97V5A3.5 3.5 0 0 0 8 1.5Z"></path>
</svg>Notifications
</a>    <tool-tip id="tooltip-5b70c82d-c633-40b6-b6bd-83e5d10f73aa" for="repository-details-watch-button" popover="manual" data-direction="s" data-type="description" data-view-component="true" class="sr-only position-absolute">You must be signed in to change notification settings</tool-tip>

    </li>

  <li>
          <a icon="repo-forked" id="fork-button" href="/login?return_to=%2F70sh1%2Fmpv-switch-both-audio" rel="nofollow" data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;repo details fork button&quot;,&quot;repository_id&quot;:718127455,&quot;auth_type&quot;:&quot;LOG_IN&quot;,&quot;originating_url&quot;:&quot;https://github.com/70sh1/mpv-switch-both-audio/blob/main/switch-both-audio.lua&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="8dab041b118a78890a1425307be469908c8125ed3b6a51d25c7860d934eecfe8" data-view-component="true" class="btn-sm btn">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-repo-forked mr-2">
  ...
  <li>
        ...
        <a href="/login?return_to=%2F70sh1%2Fmpv-switch-both-audio" rel="nofollow" data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;star button&quot;,&quot;repository_id&quot;:718127455,&quot;auth_type&quot;:&quot;LOG_IN&quot;,&quot;originating_url&quot;:&quot;https://github.com/70sh1/mpv-switch-both-audio/blob/main/switch-both-audio.lua&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="08c9cad6ad959a9d6224501a549e595832c8d19f9a7b77025334a633c9476f50" aria-label="You must be signed in to star a repository" data-view-component="true" class="tooltipped tooltipped-s btn-sm btn BtnGroup-item">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-star v-align-text-bottom d-inline-block mr-2">
  ...
  <a id="code-tab" href="/70sh1/mpv-switch-both-audio" data-tab-item="i0code-tab" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches repo_packages repo_deployments repo_attestations /70sh1/mpv-switch-both-audio" data-pjax="#repo-content-pjax-container" data-turbo-frame="repo-content-turbo-frame" data-hotkey="g c" data-analytics-event="{&quot;category&quot;:&quot;Underline navbar&quot;,&quot;action&quot;:&quot;Click tab&quot;,&quot;label&quot;:&quot;Code&quot;,&quot;target&quot;:&quot;UNDERLINE_NAV.TAB&quot;}" aria-current="page" data-view-component="true" class="UnderlineNav-item no-wrap js-responsive-underlinenav-item js-selected-navigation-item selected">
    ...
    <path d="m11.28 3.22 4.25 4.25a.75.75 0 0 1 0 1.06l-4.25 4.25a.749.749 0 0 1-1.275-.326.749.749 0 0 1 .215-.734L13.94 8l-3.72-3.72a.749.749 0 0 1 .326-1.275.749.749 0 0 1 .734.215Zm-6.56 0a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042L2.06 8l3.72 3.72a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L.47 8.53a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <li data-view-component="true" class="d-inline-flex">
  <a id="issues-tab" href="/70sh1/mpv-switch-both-audio/issues" data-tab-item="i1issues-tab" data-selected-links="repo_issues repo_labels repo_milestones /70sh1/mpv-switch-both-audio/issues /_view_fragments/issues/index/70sh1/mpv-switch-both-audio/layout" data-pjax="#repo-content-pjax-container" data-turbo-frame="repo-content-turbo-frame" data-hotkey="g i" data-analytics-event="{&quot;category&quot;:&quot;Underline navbar&quot;,&quot;action&quot;:&quot;Click tab&quot;,&quot;label&quot;:&quot;Issues&quot;,&quot;target&quot;:&quot;UNDERLINE_NAV.TAB&quot;}" data-view-component="true" class="UnderlineNav-item no-wrap js-responsive-underlinenav-item js-selected-navigation-item">
    ...
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
      ...
      <li data-view-component="true" class="d-inline-flex">
  <a id="pull-requests-tab" href="/70sh1/mpv-switch-both-audio/pulls" data-tab-item="i2pull-requests-tab" data-selected-links="repo_pulls checks /70sh1/mpv-switch-both-audio/pulls" data-pjax="#repo-content-pjax-container" data-turbo-frame="repo-content-turbo-frame" data-hotkey="g p" data-analytics-event="{&quot;category&quot;:&quot;Underline navbar&quot;,&quot;action&quot;:&quot;Click tab&quot;,&quot;label&quot;:&quot;Pull requests&quot;,&quot;target&quot;:&quot;UNDERLINE_NAV.TAB&quot;}" data-view-component="true" class="UnderlineNav-item no-wrap js-responsive-underlinenav-item js-selected-navigation-item">
    ...
    <path d="M1.5 3.25a2.25 2.25 0 1 1 3 2.122v5.256a2.251 2.251 0 1 1-1.5 0V5.372A2.25 2.25 0 0 1 1.5 3.25Zm5.677-.177L9.573.677A.25.25 0 0 1 10 .854V2.5h1A2.5 2.5 0 0 1 13.5 5v5.628a2.251 2.251 0 1 1-1.5 0V5a1 1 0 0 0-1-1h-1v1.646a.25.25 0 0 1-.427.177L7.177 3.427a.25.25 0 0 1 0-.354ZM3.75 2.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm0 9.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm8.25.75a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Z"></path>
      ...
      <li data-view-component="true" class="d-inline-flex">
  <a id="actions-tab" href="/70sh1/mpv-switch-both-audio/actions" data-tab-item="i3actions-tab" data-selected-links="repo_actions /70sh1/mpv-switch-both-audio/actions" data-pjax="#repo-content-pjax-container" data-turbo-frame="repo-content-turbo-frame" data-hotkey="g a" data-analytics-event="{&quot;category&quot;:&quot;Underline navbar&quot;,&quot;action&quot;:&quot;Click tab&quot;,&quot;label&quot;:&quot;Actions&quot;,&quot;target&quot;:&quot;UNDERLINE_NAV.TAB&quot;}" data-view-component="true" class="UnderlineNav-item no-wrap js-responsive-underlinenav-item js-selected-navigation-item">
    ...
    <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Zm4.879-2.773 4.264 2.559a.25.25 0 0 1 0 .428l-4.264 2.559A.25.25 0 0 1 6 10.559V5.442a.25.25 0 0 1 .379-.215Z"></path>
      ...
      <li data-view-component="true" class="d-inline-flex">
  <a id="security-tab" href="/70sh1/mpv-switch-both-audio/security" data-tab-item="i4security-tab" data-selected-links="security overview alerts policy token_scanning code_scanning /70sh1/mpv-switch-both-audio/security" data-pjax="#repo-content-pjax-container" data-turbo-frame="repo-content-turbo-frame" data-hotkey="g s" data-analytics-event="{&quot;category&quot;:&quot;Underline navbar&quot;,&quot;action&quot;:&quot;Click tab&quot;,&quot;label&quot;:&quot;Security&quot;,&quot;target&quot;:&quot;UNDERLINE_NAV.TAB&quot;}" data-view-component="true" class="UnderlineNav-item no-wrap js-responsive-underlinenav-item js-selected-navigation-item">
    ...
    <path d="M7.467.133a1.748 1.748 0 0 1 1.066 0l5.25 1.68A1.75 1.75 0 0 1 15 3.48V7c0 1.566-.32 3.182-1.303 4.682-.983 1.498-2.585 2.813-5.032 3.855a1.697 1.697 0 0 1-1.33 0c-2.447-1.042-4.049-2.357-5.032-3.855C1.32 10.182 1 8.566 1 7V3.48a1.75 1.75 0 0 1 1.217-1.667Zm.61 1.429a.25.25 0 0 0-.153 0l-5.25 1.68a.25.25 0 0 0-.174.238V7c0 1.358.275 2.666 1.057 3.86.784 1.194 2.121 2.34 4.366 3.297a.196.196 0 0 0 .154 0c2.245-.956 3.582-2.104 4.366-3.298C13.225 9.666 13.5 8.36 13.5 7V3.48a.251.251 0 0 0-.174-.237l-5.25-1.68ZM8.75 4.75v3a.75.75 0 0 1-1.5 0v-3a.75.75 0 0 1 1.5 0ZM9 10.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"></path>
        ...
        <span data-content="Security">Security</span>
          <include-fragment src="/70sh1/mpv-switch-both-audio/security/overall-count" accept="text/fragment+html"></include-fragment>

    
</a></li>
      <li data-view-component="true" class="d-inline-flex">
  <a id="insights-tab" href="/70sh1/mpv-switch-both-audio/pulse" data-tab-item="i5insights-tab" data-selected-links="repo_graphs repo_contributors dependency_graph dependabot_updates pulse people community /70sh1/mpv-switch-both-audio/pulse" data-pjax="#repo-content-pjax-container" data-turbo-frame="repo-content-turbo-frame" data-analytics-event="{&quot;category&quot;:&quot;Underline navbar&quot;,&quot;action&quot;:&quot;Click tab&quot;,&quot;label&quot;:&quot;Insights&quot;,&quot;target&quot;:&quot;UNDERLINE_NAV.TAB&quot;}" data-view-component="true" class="UnderlineNav-item no-wrap js-responsive-underlinenav-item js-selected-navigation-item">
  ...
  <focus-group direction="vertical" mnemonics retain>
    <button id="action-menu-a72d075f-d994-4c69-8b77-7983ae094ab1-button" popovertarget="action-menu-a72d075f-d994-4c69-8b77-7983ae094ab1-overlay" aria-controls="action-menu-a72d075f-d994-4c69-8b77-7983ae094ab1-list" aria-haspopup="true" aria-labelledby="tooltip-6a5bad0d-d8da-4dd6-ac17-8ac910207762" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium UnderlineNav-item">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-kebab-horizontal Button-visual">
    <path d="M8 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM1.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm13 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path>
</svg>
</button><tool-tip id="tooltip-6a5bad0d-d8da-4dd6-ac17-8ac910207762" for="action-menu-a72d075f-d994-4c69-8b77-7983ae094ab1-button" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Additional navigation options</tool-tip>


<anchored-position id="action-menu-a72d075f-d994-4c69-8b77-7983ae094ab1-overlay" anchor="action-menu-a72d075f-d994-4c69-8b77-7983ae094ab1-button" align="start" side="outside-bottom" anchor-offset="normal" popover="auto" data-view-component="true">
  <div data-view-component="true" class="Overlay Overlay--size-auto">
    
      <div data-view-component="true" class="Overlay-body Overlay-body--paddingNone">          <action-list>
  <div data-view-component="true">
    <ul aria-labelledby="action-menu-a72d075f-d994-4c69-8b77-7983ae094ab1-button" id="action-menu-a72d075f-d994-4c69-8b77-7983ae094ab1-list" role="menu" data-view-component="true" class="ActionListWrap--inset ActionListWrap">
        <li hidden="hidden" data-menu-item="i0code-tab" data-targets="action-list.items" role="none" data-view-component="true" class="ActionListItem">
    
    
    <a tabindex="-1" id="item-49c5117b-668f-42bf-893a-757b1a59da28" href="/70sh1/mpv-switch-both-audio" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
    ...
    <a tabindex="-1" id="item-d5642424-0eb7-4d67-93e8-c38e8110cca5" href="/70sh1/mpv-switch-both-audio/issues" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-68a75502-af37-442a-b8d0-a16db1e98f42" href="/70sh1/mpv-switch-both-audio/pulls" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-820483b1-3501-4bac-b747-f238ed556063" href="/70sh1/mpv-switch-both-audio/actions" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-play">
    <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Zm4.879-2.773 4.264 2.559a.25.25 0 0 1 0 .428l-4.264 2.559A.25.25 0 0 1 6 10.559V5.442a.25.25 0 0 1 .379-.215Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-59a32d52-9672-4e97-990f-d3086b93174a" href="/70sh1/mpv-switch-both-audio/security" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-caf1a1ca-df76-4fe5-b68f-1be86e86cf3e" href="/70sh1/mpv-switch-both-audio/pulse" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<react-app
  ...
  initial-path="/70sh1/mpv-switch-both-audio/blob/main/switch-both-audio.lua"
...
>
  ...
  <script type="application/json" data-target="react-app.embeddedData">{"payload":{"allShortcutsEnabled":false,"fileTree":{"":{"items":[{"name":"README.md","path":"README.md","contentType":"file"},{"name":"switch-both-audio.lua","path":"switch-both-audio.lua","contentType":"file"}],"totalCount":2}},"fileTreeProcessingTime":4.42825,"foldersToFetch":[],"repo":{"id":718127455,"defaultBranch":"main","name":"mpv-switch-both-audio","ownerLogin":"70sh1","currentUserCanPush":false,"isFork":false,"isEmpty":false,"createdAt":"2023-11-13T12:46:54.000Z","ownerAvatar":"https://avatars.githubusercontent.com/u/54360854?v=4","public":true,"private":false,"isOrgOwned":false},"codeLineWrapEnabled":false,"symbolsExpanded":false,"treeExpanded":true,"refInfo":{"name":"main","listCacheKey":"v0:1699879712.0","canEdit":false,"refType":"branch","currentOid":"e48f754cb2ec2096458409d329a358f31568d7f2"},"path":"switch-both-audio.lua","currentUser":null,"blob":{"rawLines":["--[[\r","\r","An mpv script that allows switching between playing one or two audio tracks simultaneously upon file load or with a hotkey.\r","\r","Note that the file must have exactly two audio tracks for this script to activate, otherwise the file will be ignored.\r","This script overrides user defiend `lavfi-complex` behavior.\r","\r","To set a keybind, add `{key} script-message switch-both-audio` line to your `input.conf` e.g:\r","\r","`n script-message switch-both-audio`\r","\r","To switch the default state to \"on\" upon opening a file, create `switch_both_audio.conf` file in `portable_config/script-opts` directory\r","and add `enabled_on_start=yes` line to it.\r","\r","\r","Repo: https://github.com/70sh1/mpv-switch-both-audio\r","\r","--]]\r","\r","require 'mp.options'\r","local mp = require 'mp'\r","local state = 'off'\r","local options = {\r","    enabled_on_start = false,\r","}\r","read_options(options,nil)\r","\r","local function switch_on()\r","    mp.set_property('lavfi-complex', '[aid1] [aid2] amix [ao]')\r","    mp.set_property('aid','no')\r","    state = 'on'\r","end\r","\r","local function switch_off()\r","    mp.set_property('lavfi-complex', '')\r","    mp.set_property_number('aid', 1)\r","    state = 'off'\r","end\r","\r","local function switch_state()\r","    if state == 'off' then\r","        switch_on()\r","    elseif state == 'on' then\r","        switch_off()\r","    end\r","end\r","\r","local function on_load()\r","    mp.unregister_script_message('switch-both-audio') -- prevent errors in mixed playlists by always disabling first\r","    local tracks_num = 0\r","    for _, track in pairs(mp.get_property_native('track-list')) do\r","        if track.type == 'audio' then\r","            tracks_num = tracks_num + 1\r","        end\r","    end\r","\r","    if tracks_num == 2 then\r","        if options.enabled_on_start then\r","            switch_on()\r","        end\r","        mp.register_script_message('switch-both-audio', switch_state)\r","    end\r","end\r","\r","mp.register_event('start-file', switch_off) -- prevent errors in mixed playlists by always disabling first\r","mp.register_event('file-loaded', on_load)\r"],"stylingDirectives":[[{"s":0,"e":4,"c":"pl-c"},{"s":0,"e":4,"c":"pl-c"}],[{"s":0,"e":0,"c":"pl-c"}],[{"s":0,"e":123,"c":"pl-c"}],[{"s":0,"e":0,"c":"pl-c"}],[{"s":0,"e":118,"c":"pl-c"}],[{"s":0,"e":60,"c":"pl-c"}],[{"s":0,"e":0,"c":"pl-c"}],[{"s":0,"e":93,"c":"pl-c"}],[{"s":0,"e":0,"c":"pl-c"}],[{"s":0,"e":36,"c":"pl-c"}],[{"s":0,"e":0,"c":"pl-c"}],[{"s":0,"e":136,"c":"pl-c"}],[{"s":0,"e":42,"c":"pl-c"}],[{"s":0,"e":0,"c":"pl-c"}],[{"s":0,"e":0,"c":"pl-c"}],[{"s":0,"e":52,"c":"pl-c"}],[{"s":0,"e":0,"c":"pl-c"}],[{"s":0,"e":4,"c":"pl-c"},{"s":0,"e":4,"c":"pl-c"}],[],[{"s":0,"e":7,"c":"pl-c1"},{"s":8,"e":20,"c":"pl-s"},{"s":8,"e":9,"c":"pl-pds"},{"s":19,"e":20,"c":"pl-pds"}],[{"s":0,"e":5,"c":"pl-k"},{"s":6,"e":8,"c":"pl-smi"},{"s":9,"e":10,"c":"pl-k"},{"s":11,"e":18,"c":"pl-c1"},{"s":19,"e":23,"c":"pl-s"},{"s":19,"e":20,"c":"pl-pds"},{"s":22,"e":23,"c":"pl-pds"}],[{"s":0,"e":5,"c":"pl-k"},{"s":6,"e":11,"c":"pl-smi"},{"s":12,"e":13,"c":"pl-k"},{"s":14,"e":19,"c":"pl-s"},{"s":14,"e":15,"c":"pl-pds"},{"s":18,"e":19,"c":"pl-pds"}],[{"s":0,"e":5,"c":"pl-k"},{"s":6,"e":13,"c":"pl-smi"},{"s":14,"e":15,"c":"pl-k"}],[{"s":4,"e":20,"c":"pl-smi"},{"s":21,"e":22,"c":"pl-k"},{"s":23,"e":28,"c":"pl-c1"}],[],[{"s":0,"e":12,"c":"pl-c1"},{"s":13,"e":20,"c":"pl-smi"},{"s":21,"e":24,"c":"pl-c1"}],[],[{"s":0,"e":5,"c":"pl-k"},{"s":6,"e
":{"line_number":27,"utf16_col":15},"end":{"line_number":27,"utf16_col":24}},"extent_utf16":{"start":{"line_number":27,"utf16_col":0},"end":{"line_number":31,"utf16_col":3}}},{"name":"switch_off","kind":"function","ident_start":1022,"ident_end":1032,"extent_start":1007,"extent_end":1138,"fully_qualified_name":"switch_off","ident_utf16":{"start":{"line_number":33,"utf16_col":15},"end":{"line_number":33,"utf16_col":25}},"extent_utf16":{"start":{"line_number":33,"utf16_col":0},"end":{"line_number":37,"utf16_col":3}}},{"name":"switch_state","kind":"function","ident_start":1157,"ident_end":1169,"extent_start":1142,"extent_end":1287,"fully_qualified_name":"switch_state","ident_utf16":{"start":{"line_number":39,"utf16_col":15},"end":{"line_number":39,"utf16_col":27}},"extent_utf16":{"start":{"line_number":39,"utf16_col":0},"end":{"line_number":45,"utf16_col":3}}},{"name":"on_load","kind":"function","ident_start":1306,"ident_end":1313,"extent_start":1291,"extent_end":1825,"fully_qualified_name":"on_load","ident_utf16":{"start":{"line_number":47,"utf16_col":15},"end":{"line_number":47,"utf16_col":22}},"extent_utf16":{"start":{"line_number":47,"utf16_col":0},"end":{"line_number":62,"utf16_col":3}}}]}},"copilotInfo":null,"copilotAccessAllowed":false,"csrf_tokens":{"/70sh1/mpv-switch-both-audio/branches":{"post":"vumoQRfLf7fiSYN7KOZZj9KOlX9rWYUXOFOekN1898YYFzt5zp1oo592G1whjTOXX6kCbb4_du-JEP7_K6Wa6Q"},"/repos/preferences":{"post":"897rcSnhCg0CiBA09C-TVNdEmpU3zaXdKnsHGrAijWOruZzzfu9pK8p2T2zoipJEBmFvxoG-NAYmw97vz8f_3A"}}},"title":"mpv-switch-both-audio/switch-both-audio.lua at main · 70sh1/mpv-switch-both-audio","appPayload":{"helpUrl":"https://docs.github.com","findFileWorkerPath":"/assets-cdn/worker/find-file-worker-1583894afd38.js","findInFileWorkerPath":"/assets-cdn/worker/find-in-file-worker-3a63a487027b.js","githubDevUrl":null,"enabled_features":{"code_nav_ui_events":false,"react_blob_overlay":false,"copilot_conversational_ux_embedding_update":false,"copilot_smell_icebreaker_ux":true,"copilot_workspace":false}}}</script>
...
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC16" class="react-file-line html-div" data-testid="code-cell" data-line-number="16" style="position:relative"><span class="pl-c">Repo: https://github.com/70sh1/mpv-switch-both-audio</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC17" class="react-file-line html-div" data-testid="code-cell" data-line-number="17" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC18" class="react-file-line html-div" data-testid="code-cell" data-line-number="18" style="position:relative"><span class="pl-c"><span class="pl-c">--]]</span></span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC19" class="react-file-line html-div" data-testid="code-cell" data-line-number="19" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC20" class="react-file-line html-div" data-testid="code-cell" data-line-number="20" style="position:relative"><span class="pl-c1">require</span> <span class="pl-s"><span class="pl-pds">&#039;</span>mp.options<span class="pl-pds">&#039;</span></span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC21" class="react-file-line html-div" data-testid="code-cell" data-line-number="21" style="position:relative"><span class="pl-k">local</span> <span class="pl-smi">mp</span> <span class="pl-k">=</span> <span class="pl-c1">require</span> <span class="pl-s"><span class="pl-pds">&#039;</span>mp<span class="pl-pds">&#039;</span></span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC22" class="react-file-line html-div" data-testid="code-cell" data-line-number="22" style="position:relative"><span class="pl-k">local</span> <span class="pl-smi">state</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">&#039;</span>off<span class="pl-pds">&#039;</span></span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC23" class="react-file-line html-div" data-testid="code-cell" data-line-number="23" style="position:relative"><span class="pl-k">local</span> <span class="pl-smi">options</span> <span class="pl-k">=</span> {</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC24" class="react-file-line html-div" data-testid="code-cell" data-line-number="24" style="position:relative">    <span class="pl-smi">enabled_on_start</span> <span class="pl-k">=</span> <span class="pl-c1">false</span>,</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC25" class="react-file-line html-div" data-testid="code-cell" data-line-number="25" style="position:relative">}</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC26" class="react-file-line html-div" data-testid="code-cell" data-line-number="26" style="position:relative"><span class="pl-c1">read_options</span>(<span class="pl-smi">options</span>,<span class="pl-c1">nil</span>)</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC27" class="react-file-line html-div" data-testid="code-cell" data-line-number="27" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC28" class="react-file-line html-div" data-testid="code-cell" data-line-number="28" style="position:relative"><span class="pl-k">local</span> <span class="pl-k">function</span> <span class="pl-en">switch_on</span>()</div></div></div><div class="child-of-line-27  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC29" class="react-file-line html-div" data-testid="code-cell" data-line-number="29" style="position:relative">    <span class="pl-smi">mp</span>.<span class="pl-c1">set_property</span>(<span class="pl-s"><span class="pl-pds">&#039;</span>lavfi-complex<span class="pl-pds">&#039;</span></span>, <span class="pl-s"><span class="pl-pds">&#039;</span>[aid1] [aid2] amix [ao]<span class="pl-pds">&#039;</span></span>)</div></div></div><div class="child-of-line-27  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC30" class="react-file-line html-div" data-testid="code-cell" data-line-number="30" style="position:relative">    <span class="pl-smi">mp</span>.<span class="pl-c1">set_property</span>(<span class="pl-s"><span class="pl-pds">&#039;</span>aid<span class="pl-pds">&#039;</span></span>,<span class="pl-s"><span class="pl-pds">&#039;</span>no<span class="pl-pds">&#039;</span></span>)</div></div></div><div class="child-of-line-27  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC31" class="react-file-line html-div" data-testid="code-cell" data-line-number="31" style="position:relative">    <span class="pl-smi">state</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">&#039;</span>on<span class="pl-pds">&#039;</span></span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC32" class="react-file-line html-div" data-testid="code-cell" data-line-number="32" style="position:relative"><span class="pl-k">end</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC33" class="react-file-line html-div" data-testid="code-cell" data-line-number="33" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC34" class="react-file-line html-div" data-testid="code-cell" data-line-number="34" style="position:relative"><span class="pl-k">local</span> <span class="pl-k">function</span> <span class="pl-en">switch_off</span>()</div></div></div><div class="child-of-line-33  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC35" class="react-file-line html-div" data-testid="code-cell" data-line-number="35" style="position:relative">    <span class="pl-smi">mp</span>.<span class="pl-c1">set_property</span>(<span class="pl-s"><span class="pl-pds">&#039;</span>lavfi-complex<span class="pl-pds">&#039;</span></span>, <span class="pl-s"><span class="pl-pds">&#039;</span><span class="pl-pds">&#039;</span></span>)</div></div></div><div class="child-of-line-33  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC36" class="react-file-line html-div" data-testid="code-cell" data-line-number="36" style="position:relative">    <span class="pl-smi">mp</span>.<span class="pl-c1">set_property_number</span>(<span class="pl-s"><span class="pl-pds">&#039;</span>aid<span class="pl-pds">&#039;</span></span>, <span class="pl-c1">1</span>)</div></div></div><div class="child-of-line-33  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC37" class="react-file-line html-div" data-testid="code-cell" data-line-number="37" style="position:relative">    <span class="pl-smi">state</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">&#039;</span>off<span class="pl-pds">&#039;</span></span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC38" class="react-file-line html-div" data-testid="code-cell" data-line-number="38" style="position:relative"><span class="pl-k">end</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC39" class="react-file-line html-div" data-testid="code-cell" data-line-number="39" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC40" class="react-file-line html-div" data-testid="code-cell" data-line-number="40" style="position:relative"><span class="pl-k">local</span> <span class="pl-k">function</span> <span class="pl-en">switch_state</span>()</div></div></div><div class="child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC41" class="react-file-line html-div" data-testid="code-cell" data-line-number="41" style="position:relative">    <span class="pl-k">if</span> <span class="pl-smi">state</span> <span class="pl-k">==</span> <span class="pl-s"><span class="pl-pds">&#039;</span>off<span class="pl-pds">&#039; </span></span><span class="pl-k">then</span></div></div></div><div class="child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC42" class="react-file-line html-div" data-testid="code-cell" data-line-number="42" style="position:relative">        <span class="pl-c1">switch_on</span>()</div></div></div><div class="child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC43" class="react-file-line html-div" data-testid="code-cell" data-line-number="43" style="position:relative">    <span class="pl-k">elseif</span> <span class="pl-smi">state</span> <span class="pl-k">==</span> <span class="pl-s"><span class="pl-pds">&#039;</span>on<span class="pl-pds">&#039; </span></span><span class="pl-k">then</span></div></div></div><div class="child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC44" class="react-file-line html-div" data-testid="code-cell" data-line-number="44" style="position:relative">        <span class="pl-c1">switch_off</span>()</div></div></div><div class="child-of-line-39  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC45" class="react-file-line html-div" data-testid="code-cell" data-line-number="45" style="position:relative">    <span class="pl-k">end</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC46" class="react-file-line html-div" data-testid="code-cell" data-line-number="46" style="position:relative"><span class="pl-k">end</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC47" class="react-file-line html-div" data-testid="code-cell" data-line-number="47" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC48" class="react-file-line html-div" data-testid="code-cell" data-line-number="48" style="position:relative"><span class="pl-k">local</span> <span class="pl-k">function</span> <span class="pl-en">on_load</span>()</div></div></div><div class="child-of-line-47  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC49" class="react-file-line html-div" data-testid="code-cell" data-line-number="49" style="position:relative">    <span class="pl-smi">mp</span>.<span class="pl-c1">unregister_script_message</span>(<span class="pl-s"><span class="pl-pds">&#039;</span>switch-both-audio<span class="pl-pds">&#039;</span></span>) <span class="pl-c"><span class="pl-c">--</span> prevent errors in mixed playlists by always disabling first</span></div></div></div><div class="child-of-line-47  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC50" class="react-file-line html-div" data-testid="code-cell" data-line-number="50" style="position:relative">    <span class="pl-k">local</span> <span class="pl-smi">tracks_num</span> <span class="pl-k">=</span> <span class="pl-c1">0</span></div></div></div><div class="child-of-line-47  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC51" class="react-file-line html-div" data-testid="code-cell" data-line-number="51" style="position:relative">    <span class="pl-k">for</span> <span class="pl-smi">_</span>, <span class="pl-smi">track</span> <span class="pl-k">in</span> <span class="pl-c1">pairs</span>(<span class="pl-smi">mp</span>.<span class="pl-c1">get_property_native</span>(<span class="pl-s"><span class="pl-pds">&#039;</span>track-list<span class="pl-pds">&#039;</span></span>)) <span class="pl-k">do</span></div></div></div><div class="child-of-line-47  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC52" class="react-file-line html-div" data-testid="code-cell" data-line-number="52" style="position:relative">        <span class="pl-k">if</span> <span class="pl-smi">track</span>.<span class="pl-e">type</span> <span class="pl-k">==</span> <span class="pl-s"><span class="pl-pds">&#039;</span>audio<span class="pl-pds">&#039; </span></span><span class="pl-k">then</span></div></div></div><div class="child-of-line-47  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC53" class="react-file-line html-div" data-testid="code-cell" data-line-number="53" style="position:relative">            <span class="pl-smi">tracks_num</span> <span class="pl-k">=</span> <span class="pl-smi">tracks_num</span> <span class="pl-k">+</span> <span class="pl-c1">1</span></div></div></div><div class="child-of-line-47  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC54" class="react-file-line html-div" data-testid="code-cell" data-line-number="54" style="position:relative">        <span class="pl-k">end</span></div></div></div><div class="child-of-line-47  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC55" class="react-file-line html-div" data-testid="code-cell" data-line-number="55" style="position:relative">    <span class="pl-k">end</span></div></div></div><div class="child-of-line-47  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC56" class="react-file-line html-div" data-testid="code-cell" data-line-number="56" style="position:relative">
</div></div></div><div class="child-of-line-47  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC57" class="react-file-line html-div" data-testid="code-cell" data-line-number="57" style="position:relative">    <span class="pl-k">if</span> <span class="pl-smi">tracks_num</span> <span class="pl-k">==</span> <span class="pl-c1">2</span> <span class="pl-k">then</span></div></div></div><div class="child-of-line-47  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC58" class="react-file-line html-div" data-testid="code-cell" data-line-number="58" style="position:relative">        <span class="pl-k">if</span> <span class="pl-smi">options</span>.<span class="pl-e">enabled_on_start</span> <span class="pl-k">then</span></div></div></div><div class="child-of-line-47  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC59" class="react-file-line html-div" data-testid="code-cell" data-line-number="59" style="position:relative">            <span class="pl-c1">switch_on</span>()</div></div></div><div class="child-of-line-47  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC60" class="react-file-line html-div" data-testid="code-cell" data-line-number="60" style="position:relative">        <span class="pl-k">end</span></div></div></div><div class="child-of-line-47  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC61" class="react-file-line html-div" data-testid="code-cell" data-line-number="61" style="position:relative">        <span class="pl-smi">mp</span>.<span class="pl-c1">register_script_message</span>(<span class="pl-s"><span class="pl-pds">&#039;</span>switch-both-audio<span class="pl-pds">&#039;</span></span>, <span class="pl-smi">switch_state</span>)</div></div></div><div class="child-of-line-47  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC62" class="react-file-line html-div" data-testid="code-cell" data-line-number="62" style="position:relative">    <span class="pl-k">end</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC63" class="react-file-line html-div" data-testid="code-cell" data-line-number="63" style="position:relative"><span class="pl-k">end</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC64" class="react-file-line html-div" data-testid="code-cell" data-line-number="64" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC65" class="react-file-line html-div" data-testid="code-cell" data-line-number="65" style="position:relative"><span class="pl-smi">mp</span>.<span class="pl-c1">register_event</span>(<span class="pl-s"><span class="pl-pds">&#039;</span>start-file<span class="pl-pds">&#039;</span></span>, <span class="pl-smi">switch_off</span>) <span class="pl-c"><span class="pl-c">--</span> prevent errors in mixed playlists by always disabling first</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC66" class="react-file-line html-div" data-testid="code-cell" data-line-number="66" style="position:relative"><span class="pl-smi">mp</span>.<span class="pl-c1">register_event</span>(<span class="pl-s"><span class="pl-pds">&#039;</span>file-loaded<span class="pl-pds">&#039;</span></span>, <span class="pl-smi">on_load</span>)</div></div></div></div></div></div><div id="copilot-button-container"></div></div><div id="highlighted-line-menu-container"></div></div></div><button hidden="" data-testid="hotkey-button" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></section></div></div></div> <!-- --> <!-- --> </div></div></div><div class="Box-sc-g0xbh4-0"></div></div></div></div></div><div id="find-result-marks-container" class="Box-sc-g0xbh4-0 aZrVR"></div><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></div> <!-- --> <!-- --> <script type="application/json" id="__PRIMER_DATA_:R0:__">{"resolvedServerColorMode":"day"}</script></div>
</react-app>
</turbo-frame>
