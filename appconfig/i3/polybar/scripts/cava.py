...
# add color to bars
BAR_CHARACTERS = dict([
    (000, '%{F#100}▁%{F-}'),  # Zero output

    (BAR_FACTOR * 1, '%{F#200}▁%{F-}'),
    (BAR_FACTOR * 2, '%{F#500}▂%{F-}'),
    (BAR_FACTOR * 3, '%{F#700}▃%{F-}'),
    (BAR_FACTOR * 4, '%{F#900}▄%{F-}'),
    (BAR_FACTOR * 5, '%{F#A00}▅%{F-}'),
    (BAR_FACTOR * 6, '%{F#B00}▆%{F-}'),
    (BAR_FACTOR * 7, '%{F#C00}▇%{F-}'),

    (100, '%{F#F00}█%{F-}'),  # Highest output
])
