...
let wiki_notes.template_path = '~/linux-setup/submodules/pandoc-goodies/templates/html5/github/'
...
let wiki_notes.custom_wiki2html = '~/notes/wiki2html.sh'
let wiki_notes.path_html = '~/notes/html'
...
" let mrs_wiki = {}
" let mrs_wiki.path = '~/.ctu-mrs.github.io'
" let mrs_wiki.template_path = '~/linux-setup/submodules/pandoc-goodies/templates/html5/github/'
...
" let mrs_wiki.ext = '.md'
" let mrs_wiki.custom_wiki2html = '~/linux-setup/appconfig/vim/vimwiki_templates/wiki2html.sh'
" let mrs_wiki.path_html = '~/.ctu-mrs.github.io'

" let mrs_uav_system = {}
" let mrs_uav_system.path = '~/mrs_uav_system'
" let mrs_uav_system.html_template = '~/linux-setup/appconfig/vim/vimwiki_templates/default.html'
...
" let mrs_uav_system.custom_wiki2html = '~/linux-setup/appconfig/vim/vimwiki_templates/wiki2html.sh'
" let mrs_uav_system.path_html = '~/mrs_uav_system/html/'

" let profile_manager = {}
" let profile_manager.path = '~/profile_manager'
" let profile_manager.html_template = '~/linux-setup/appconfig/vim/vimwiki_templates/default.html'
...
" let profile_manager.custom_wiki2html = '~/linux-setup/appconfig/vim/vimwiki_templates/wiki2html.sh'
" let profile_manager.path_html = '~/profile_manager/html/'

" let linux_setup_wiki = {}
" let linux_setup_wiki.path = '~/linux-setup.wiki'
" let linux_setup_wiki.html_template = '~/linux-setup/appconfig/vim/vimwiki_templates/default.html'
...
" let linux_setup_wiki.custom_wiki2html = '~/linux-setup/appconfig/vim/vimwiki_templates/wiki2html.sh'
" let linux_setup_wiki.path_html = '~/linux-setup.wiki/html/'
...
" let wiki_exam = {}
" let wiki_exam.path = '~/state_exam'
" let wiki_exam.html_template = '~/linux-setup/appconfig/vim/vimwiki_templates/default.html'
...
" let wiki_exam.custom_wiki2html = '~/linux-setup/appconfig/vim/vimwiki_templates/wiki2html.sh'
" let wiki_exam.path_html = '~/.wiki/html/'

" let naki = {}
" let naki.path = '~/pr2018-naki_platform'
" let naki.html_template = '~/linux-setup/appconfig/vim/vimwiki_templates/default.html'
" let naki.nested_syntaxes = {'python': 'python', 'c++': 'cpp', 'bash': 'sh'}
" let naki.index = 'README'
" let naki.syntax = 'markdown'
" let naki.ext = '.md'
" let naki.custom_wiki2html = '~/linux-setup/appconfig/vim/vimwiki_templates/wiki2html.sh'
" let naki.path_html = '~/pr2018-naki_platform/html/'
...
" let wiki_school = {}
" let wiki_school.path = '~/notes/school'
" let wiki_school.template_path = '~/linux-setup/submodules/pandoc-goodies/templates/html5/github/'
...
" let wiki_school.custom_wiki2html = '~/notes/wiki2html.sh'
" let wiki_school.path_html = '~/notes/html'

" let wiki_naki = {}
" let wiki_naki.path = '~/notes/projects/NAKI'
" let wiki_naki.template_path = '~/linux-setup/submodules/pandoc-goodies/templates/html5/github/'
...
" let wiki_naki.custom_wiki2html = '~/notes/wiki2html.sh'
" let wiki_naki.path_html = '~/notes/html'

" let wiki_darpa = {}
" let wiki_darpa.path = '~/notes/projects/DARPA'
" let wiki_darpa.template_path = '~/linux-setup/submodules/pandoc-goodies/templates/html5/github/'
...
" let wiki_darpa.custom_wiki2html = '~/notes/wiki2html.sh'
" let wiki_darpa.path_html = '~/notes/html'
...
" " let wiki_darpa_shared.path = '~/notes_darpa'
" " let wiki_darpa_shared.template_path = '~/linux-setup/submodules/pandoc-goodies/templates/html5/github/'
...
" " let wiki_darpa_shared.custom_wiki2html = '~/notes_darpa/wiki2html.sh'
" " let wiki_darpa_shared.path_html = '~/notes_darpa/html'
...
" let wiki_1.template_path = '~/linux-setup/submodules/pandoc-goodies/templates/html5/github/'
...
" let wiki_1.ext = '.md'
" let wiki_1.custom_wiki2html = '~/notes/wiki2html.sh'
" let wiki_1.path_html = '~/notes/html'
...
" autocmd BufWritePost */notes/* call VimuxRunCommand("cd ~/notes; nohup ./save_and_update.sh & exit       ")
" autocmd BufWritePost */notes/* AsyncRun bash -c ~/notes/save_and_update.sh
